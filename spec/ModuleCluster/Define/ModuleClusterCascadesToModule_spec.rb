  ...
  it 'include modules for any class this module or any including modules are included in' do
    module ModuleCluster::Define::ModuleClusterCascadesToModule::Mock01
      ...
      module Proof1
        ...
        ancestors.include?( ModuleCluster::Define::ModuleClusterCascadesToModule::Mock01::Module1 ).should == false
        ancestors.include?( ModuleCluster::Define::ModuleClusterCascadesToModule::Mock01::Module2 ).should == false
      end
      module Proof2
  ...
  it 'include and extends modules for any class this module or any including modules are included in' do
    module ModuleCluster::Define::ModuleClusterCascadesToModule::Mock03
      ...
      module Proof1
        ...
        ancestors.include?( ModuleCluster::Define::ModuleClusterCascadesToModule::Mock03::Module1 ).should == false
        ancestors.include?( ModuleCluster::Define::ModuleClusterCascadesToModule::Mock03::Module2 ).should == false
        eigenclass = class << self ; self ; end
  ...
  it 'include and extend modules for any class this module is extended in' do
    module ModuleCluster::Define::ModuleClusterCascadesToModule::Mock06
      ...
      module Proof1
        ...
        eigenclass = class << self ; self ; end
        eigenclass.ancestors.include?( ModuleCluster::Define::ModuleClusterCascadesToModule::Mock06::Module1 ).should == false
        eigenclass.ancestors.include?( ModuleCluster::Define::ModuleClusterCascadesToModule::Mock06::Module2 ).should == false
      end
      module Proof2
  ...
  it 'include other modules for any class this module or any including modules are included in, before this module or including module is included' do
    module ModuleCluster::Define::ModuleClusterCascadesToModule::Mock07
      ...
      module Proof1
        ...
        ancestors.include?( ModuleCluster::Define::ModuleClusterCascadesToModule::Mock07::Module1 ).should == false
        ancestors.include?( ModuleCluster::Define::ModuleClusterCascadesToModule::Mock07::Module2 ).should == false
      end
      module Proof2
  ...
  it 'include and extend other modules for any class this module or any including modules are included in, before this module or including module is included' do
    module ModuleCluster::Define::ModuleClusterCascadesToModule::Mock09
      ...
      module Proof1
        ...
        ancestors.include?( ModuleCluster::Define::ModuleClusterCascadesToModule::Mock09::Module1 ).should == false
        ancestors.include?( ModuleCluster::Define::ModuleClusterCascadesToModule::Mock09::Module2 ).should == false
        eigenclass = class << self ; self ; end
  ...
  it 'include and extend other modules for any class this module or any including modules are included in, before this module is extended' do
    module ModuleCluster::Define::ModuleClusterCascadesToModule::Mock12
      ...
      module Proof2
        ...
        eigenclass = class << self ; self ; end
        eigenclass.ancestors.include?( ModuleCluster::Define::ModuleClusterCascadesToModule::Mock12::Module1 ).should == false
        eigenclass.ancestors.include?( ModuleCluster::Define::ModuleClusterCascadesToModule::Mock12::Module2 ).should == false
      end
      class Proof3
